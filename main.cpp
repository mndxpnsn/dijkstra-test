...
int main(int argc, char* argv[]) {
    ...
    int n = 24990; //Number of vertices
    int num_edges = 61250; //Number of edges
...
//    std::cout << std::endl;
    ...
    std::cout << "number of operations estimated fib heap 8V + 3E + 6.4VlgV: " << tot_num_ops_est << std::endl;
